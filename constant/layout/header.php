            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.php">
                        ...
                        <b><img src="./assets/uploadImage/Logo/ANN.jpg" style="width: 45%;" alt="homepage" class="dark-logo" style="width:100%;height:auto;"/></b>
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0 ml-auto">
                      ...
                      <img src="./assets/uploadImage/Logo/images.png" alt="user" style="height: 30px;
    width: auto;
    margin-top: 16px;
    margin-right: 10px;">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img src="./assets/uploadImage/Profile/young-woman-avatar-facial-features-stylish-userpic-flat-cartoon-design-elegant-lady-blue-jacket-close-up-portrait-80474088.png" alt="user" class="profile-pic" /></a>
